...
```
cd existing_repo
git remote add origin https://gitlab.bor.doi.net/usbr-cvp-modeling/calsim_dss_reader.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.bor.doi.net/usbr-cvp-modeling/calsim_dss_reader/-/settings/integrations)
